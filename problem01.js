...
const showBtn = (id) => {
    ...
    const inputBTN = inputFeild.value
...
const displayImage = ({ hits }) => {
    ...
    hits.forEach((Image) => {
        ...
        div.innerHTML = ` <img class="img-fluid mt-5" onclick=selectItem(event,"${Image.webformatURL}") src="${Image.webformatURL}" alt="${Image.tags}">`
        console.log(div.classList)
        console.log(div.innerHTML)
        displayImg.appendChild(div)
    });
}
addEventListener("setTimeout", showBtn, 50000)
